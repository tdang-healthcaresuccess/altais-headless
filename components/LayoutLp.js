...
const LayoutLp = ({ children, siteTitle = 'Altais: Shaping the Future of Healthcare', siteDescription = '', metaD = null, noIndex = false, schemaMarkup = '' }) => {
  // ...existing code...
  // SSR meta rendering
  ...
  <Head>
      ...
      <div className="min-h-screen flex flex-col">
        <HeaderLp siteTitle={siteTitle} siteDescription={siteDescription} metaD={metaD} noIndex={noIndex} />
