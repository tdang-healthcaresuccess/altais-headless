      ...
      <div className="container mx-auto">
        <div className="block md:flex flex-wrap gap-[70px]">
          ...
          <div className="block w-full md:w-[calc(62%-35px)]">
            <h3 className="text-[22px] leading-[32px] font-medium text-bluePrimary mb-8">A Network Bringing High-quality and Affordable Care to All</h3>
            <p className="text-lg font-normal !leading-[32px] text-grey3d mb-8">
