...
export default function SearchDoctor() {
  return (
    <section className="block pt-[50px] md:pt-14 pb-[73px] md:pb-15 px-4 md:px-0 shadow-custom">
          ...
          <div className="block flex-1">
            ...
            <div className="block w-full">
              <div className="flex gap-5 justify-between mb-5">
                ...
                <div className="block">
                  <select type="text" placeholder="Doctor Name" className="input-style w-full md:max-w-[134px] md:min-w-[134px] cursor-pointer">
              ...
              <div className="flex gap-5 justify-between">
                ...
                <div className="block flex-1">
                  <select type="text" placeholder="Specialty" className="input-style w-full cursor-pointer">
