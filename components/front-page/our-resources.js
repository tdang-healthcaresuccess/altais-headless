      ...
      <div className="container mx-auto">
        <div className="flex flex-wrap gap-7">
          <div className="flex flex-1 mb-4 md:mb-12 gap-6">
            <div className="block">
              <Image src={PatientsMedia} alt="Patients" className="rounded-normal border border-[#C75327] w-[130px] min-w-[130px] h-[130px]" />
            </div>
          ...
          <div className="flex flex-1 mb-4 md:mb-12 gap-6">
            <div className="block">
              <Image src={ProvidersMedia} alt="Providers" className="rounded-normal border border-[#C75327] w-[130px] min-w-[130px] h-[130px]" />
            </div>
            <div className="block w-full md:w-auto"> 
          ...
          <div className="flex flex-1 mb-[75px] md:mb-12 gap-6">
            <div className="block">
              <Image src={PartnersMedia} alt="Partners" className="rounded-normal border border-[#C75327] w-[130px] min-w-[130px] h-[130px]" />
            </div>
            <div className="block w-full md:w-auto">
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap gap-12 md:gap-8">
          <div className="block flex-auto md:flex-1">
            ...
            <Link
              href="/#"
              className="btn-outline-secondary btn-sm flex-center !w-[165px] !px-2 rounded-normal gap-1 mt-8"
            >
              Find Care{" "}
