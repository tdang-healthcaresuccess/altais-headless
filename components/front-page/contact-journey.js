...
export default function ContactJourney() {
  return (
    <section className="block pt-[50px] bg-[#d9d9d926] md:pt-14 pb-[73px] md:pb-15 px-4 md:px-0 shadow-[inset_0px_2px_4px_0px_rgba(61,61,61,0.15)]">
        ...
        <div className="block md:flex justify-center items-start">
          ...
          <div className="flex justify-center md:justify-end">
            <h3 className="flex flex-col font-light text-center md:text-left max-w-[250px] text-[#083D78]">
              <b className="font-medium">Let’s Redefine</b> What Care Feels Like
            </h3>
          </div>
